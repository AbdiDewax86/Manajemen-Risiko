                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <a href="MR_admin_user_tambah.html" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm btn-block py-3">
                                        Tambah User Baru
                                    </a>
                                </div>
                                    <div class="topbar-divider d-none d-sm-block"></div>
                                <div class="col-md-6 col-12">
                                    ...
                                    <a href="MR_admin_user_kelola.html" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm btn-block py-3">
                                        Kelola Data User
                                    </a>
                                </div>
                            </div>
