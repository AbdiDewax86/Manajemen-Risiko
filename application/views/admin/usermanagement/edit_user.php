                            ...
                            <form class="user" action="" method="post" enctype="multipart/form-data">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <input class="form-control" name="user_id" value="<?php echo $users->user_id ?>" readonly> 
                                    </div>
                                </div>
                                <h4>Data User</h4>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        type="email" name="email" placeholder="E-mail..." value="<?php echo $users->email ?>"> 
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-4 col-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        type="text" name="fullname" placeholder="Nama Lengkap..."  value="<?php echo $users->fullname ?>"> 
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-4 col-12">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        type="text" name="phone" placeholder="Username..." value="<?php echo $users->phone ?>">  
                                    </div>
                                </div>
