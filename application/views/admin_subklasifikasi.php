        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Manajemen Subklasifikasi</h1>
                    <p class="mb-4">
                        Fitur Khusus Admin dan Operator. Tambah Subklasifikasi baru, 
                        Ubah data Subklasifikasi, dan ubah data identifikasi risiko 
                        dalam tiap subklasifikasi.
                    </p>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    ...
                                    <a href="MR_admin_subklasifikasi_tambah.html" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm btn-block py-3">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <a href="MR_admin_subklasifikasi_kelola.html" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm btn-block py-3">
                                        Kelola Data Sub Klasifikasi
                                    </a>
                                </div>
                            </div>
                        </div>
