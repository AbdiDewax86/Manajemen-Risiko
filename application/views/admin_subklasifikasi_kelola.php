        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Kelola Subklasifikasi</h1>
                    <p class="mb-4">
                        Kelola data subklasifikasi yang sudah dimasukkan. Update data subklasifikasi dan hapus subklasifikasi.
                        Subklasifikasi dari semua klasifikasi muncul dalam tabel dibawah.
                    </p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Daftar Identifikasi Risiko Informasi</h6>
                        </div>
                        <div class="card-body">
